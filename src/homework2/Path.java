...
/**
 * A homework2.Path models a sequence of nodes and the cost for traveling along
 ...
 * <pre>
 *   cost : double              // cost of traversing this homework2.Path
 *   elements : sequence        // the nodes in this homework2.Path
 * </pre>
 *
 * <p>
 ...
 * implementing class itself (see homework2.WeightedNodePath for an example). Why is this
 * second argument necessary? Imagine that this interface was defined as
 * <tt>public interface homework2.Path&lt;N&gt;</tt>. Then the <tt>extend</tt>
 * function would be defined as returning a <tt>homework2.Path&lt;N&gt;</tt>. But this
 * is not specific enough; for example, the extend method on homework2.WeightedNodePath
 * could return a homework2.NodeCountingPath, or vice versa! The second generic
...
public interface Path<N, P extends Path<N,P>>
	 ...
	 *	 		 implementation
	 * @return a new homework2.Path p such that
