...
/**
 * A homework2.NodeCountingPath characterizes a path of WeightedNodes. The cost for
 * a path is the number of WeightedNodes it contains; the cost of the
 * WeightedNodes are ignored.
 * <p>
 * A homework2.NodeCountingPath is immutable. A new homework2.NodeCountingPath is returned
...
public class NodeCountingPath implements Path<WeightedNode, NodeCountingPath> {
	...
	// the homework2.Path interface, namely the cost and elements of a path.
	//
	...
	/**
	 * The homework2.WeightedNode at the end of the path.
	 */
	private final WeightedNode node;

	/**
	 * A homework2.NodeCountingPath which, when extended with 'node' at the end, is
	 * equal to this. May be null iff this path has only 1 element.
	 */
	private final NodeCountingPath path;

	/**
	 * Cost of this homework2.NodeCountingPath (that is, its length).
	 */
	private final int cost;


	/**
	 * Creates a homework2.NodeCountingPath containing one node.
	 * @requires node != null
	 * @effects Creates a new homework2.NodeCountingPath which originates at
	 * <tte>node</tt>.
	 */
	...
	/**
	 * Creates a homework2.NodeCountingPath from a homework2.WeightedNode and
	 * a homework2.NodeCountingPath.
	 * @requires node != null
	 * @effects Creates a new homework2.NodeCountingPath 'res' such that
	 ...
	 * @requires node != null
	 * @return a new homework2.NodeCountingPath p such that
	 ...
	 * 		   [homework2.NodeCountingPath: node1, node2, node3, ...].
	 */
	public String toString() {
		StringBuffer buff = new StringBuffer();
		buff.append("[homework2.NodeCountingPath: ");
		boolean first = true;
	 ...
	 * @return true iff o is a homework2.NodeCountingPath and o.elements is the
